  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        '@ts-minecraft/kernel': resolve(process.cwd(), 'packages/kernel'),
        ...
        '@ts-minecraft/terrain': resolve(process.cwd(), 'packages/terrain'),
        '@ts-minecraft/world-state': resolve(process.cwd(), 'packages/world-state'),
