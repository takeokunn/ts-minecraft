...
export const WeatherState = Schema.Struct({
  ...
  pressure: Pressure,
  windSpeed: WindSpeed,
  windDirection: Schema.Number.pipe(Schema.between(0, 360)), // degrees
  cloudCoverage: CloudCoverage,
  precipitationIntensity: Schema.Number.pipe(Schema.between(0, 1)),
  visibility: Schema.Number.pipe(Schema.between(0, 1000)), // meters
