...
*🔗 関連リソース*: [Domain Layer](02-domain-layer-architecture.md) • [Effect-TS Services](../effect-ts-fundamentals/effect-ts-services.md) • [Service Patterns](../../explanations/design-patterns/service-patterns.md)