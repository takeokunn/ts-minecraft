...
class GameStateService extends Context.Tag("GameStateService")<GameStateService, GameStateServiceInterface> {}
...
class GameEngine extends Context.Tag("GameEngine")<GameEngine, GameEngineInterface> {}
