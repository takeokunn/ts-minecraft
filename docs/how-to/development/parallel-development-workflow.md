...
description: '効率的な並列開発の完全ガイド'
category: 'workflow'
difficulty: 'intermediate'
tags: ['parallel-development', 'dependency-management', 'team-workflow']
prerequisites: ['basic-git', 'project-structure']
...
- **[ROADMAP](../ROADMAP.md)** - 全体計画とフェーズ構成
