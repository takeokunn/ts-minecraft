...
// Error Types
export class EnchantingError extends Schema.TaggedError<EnchantingError>()("EnchantingError", {
...
export class IncompatibleEnchantmentError extends Schema.TaggedError<IncompatibleEnchantmentError>()("IncompatibleEnchantmentError", {
  conflictingEnchantments: Schema.Array(EnchantmentId)
}) {}

export class AnvilError extends Schema.TaggedError<AnvilError>()("AnvilError", {
