...
export const WeatherGenerationError = Schema.TaggedError("WeatherGenerationError")({
  message: string
  cause?: unknown
  timestamp: number
})

export const PredictionError = Schema.TaggedError("PredictionError")({
  message: string
  hoursAhead: number
  timestamp: number
})

export const LightningError = Schema.TaggedError("LightningError")({
  message: string
  strikeId?: string
  timestamp: number
})

export const ClimateSimulationError = Schema.TaggedError("ClimateSimulationError")({
  message: string
  region?: string
  timestamp: number
})
