...
- [x] **7ステージ Effect.gen → flatMap 変換**: chunk-sync-stage, input-stage, hotbar-handler, multiplayer-stage, lighting-stage, post-processing-stage (x2), physics-stage-utils ✅ (commits 4d9cc08, f113715, 53ecdb4)
