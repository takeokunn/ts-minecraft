...
- 2026-06-12: **物理パイプライン最適化** — blendVelocityInto, computeFlightPositionInto, sneak clampアンロール (commit d6eb7a4, Oracle指摘)
- 2026-06-12: 品質ゲート: typecheck 0, lint 0/2w, 5667 tests, build OK
- 2026-06-12: **P4.1 未完了** — `runFrameStages` Effect.gen分離はブラウザヒープ測定ゲートが必要（アーキテクチャ変更）
- 2026-06-12: **状況**: 4本柱のうち3本（データ指向設計、メッシュ最適化、ゼロアロケーション化）は完了または大幅改善。1本（Effect-TS分離）は P4.1 としてドキュメント化・測定ゲート付きで保留。
