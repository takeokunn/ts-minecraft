...
/** Sea level Y coordinate — water fills ocean biome areas up to this height (Phase 2.1 MC 1.18-aligned) */
export const SEA_LEVEL = 63

/** Inland lake water surface level — lakes fill up to this height in non-ocean biomes (Phase 2.1 MC 1.18-aligned) */
