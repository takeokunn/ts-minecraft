...
import { Inventory, ItemStack, type PlayerId } from '../../domain/inventory/types'
...
import { InventoryZustandEffects, useInventoryStore } from '../../presentation/state/inventory/zustand-store'
...
export const InventoryIntegrationService = Context.GenericTag<InventoryIntegrationService>(
  '@minecraft/application/inventory/IntegrationService'
)
