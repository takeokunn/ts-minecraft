...
import type { ItemCategory, ItemDefinition } from '../../domain/inventory/ItemRegistry'
import { ItemRegistry } from '../../domain/inventory/ItemRegistry'
import type { ItemId } from '../../domain/inventory/types'
import { ItemIdSchema, ItemMetadata } from '../../domain/inventory/types'
...
// Context tag
export const ItemManagerService = Context.GenericTag<ItemManagerService>(
  '@minecraft/application/inventory/ItemManagerService'
)
