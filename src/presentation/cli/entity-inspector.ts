...
export const createEntityInspector = (world: World, config: Partial<EntityInspectorConfig> = {}) =>
  Effect.gen(function* () {
     ...
     */
    const createHeader = (parent: HTMLElement) => Effect.gen(function* () {
     ...
     */
    const createContent = (parent: HTMLElement) => Effect.gen(function* () {
     ...
     */
    const setupEventListeners = (inspectorElement: HTMLElement) => Effect.gen(function* () {
      const state = yield* Ref.get(stateRef)
     ...
     */
    const selectEntity = (entityId: string) => Effect.gen(function* () {
     ...
     */
    const displayEntityDetails = (entityId: string) => Effect.gen(function* () {
      const state = yield* Ref.get(stateRef)
     ...
     * Get entity by ID
     */
    const getEntityById = (id: string) => Effect.gen(function* () {
      const entities = yield* getEntities()
     ...
     * Delete entity
     */
    const deleteEntity = (id: string) => Effect.gen(function* () {
     ...
     */
    const toggleEntity = (id: string) => Effect.gen(function* () {
     ...
     * Clone entity
     */
    const cloneEntity = (id: string) => Effect.gen(function* () {
     ...
     */
    const inspectEntity = (id: string) => Effect.gen(function* () {
      const state = yield* Ref.get(stateRef)
      if (!state.isOpen) {
        yield* open()
      }
     ...
     */
    const findEntitiesByComponent = (componentType: string) => Effect.gen(function* () {
      const entities = yield* getEntities()
 ...
 */
export const createEntityInspectorFactory = (config: Partial<EntityInspectorConfig> = {}) =>
  (world: World) => createEntityInspector(world, config)