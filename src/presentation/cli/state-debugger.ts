...
export const createStateDebugger = (world: World, config: Partial<StateDebuggerConfig> = {}) =>
  Effect.gen(function* () {
    ...
    const createToolbar = (parentElement: HTMLElement) =>
      Effect.gen(function* () {
    ...
    const createMainContent = (parentElement: HTMLElement) =>
      Effect.gen(function* () {
    ...
    const createSnapshotPanel = (parentElement: HTMLElement) =>
      Effect.gen(function* () {
    ...
    const createDetailsPanel = (parentElement: HTMLElement) =>
      Effect.gen(function* () {
        const panel = document.createElement('div')
        panel.style.cssText = `
      flex: 1;
    ...
    const loadSnapshot = (snapshot: StateSnapshot) =>
      Effect.gen(function* () {
    ...
    const watchComponent = (componentType: string) =>
      Effect.gen(function* () {
        yield* Ref.update(stateRef, (state) => ({
          ...state,
    ...
    const unwatchComponent = (componentType: string) =>
      Effect.gen(function* () {
        yield* Ref.update(stateRef, (state) => {
    ...
    const updateConfig = (newConfig: Partial<StateDebuggerConfig>) =>
      Effect.gen(function* () {
        yield* Ref.update(stateRef, (state) => ({
          ...state,
