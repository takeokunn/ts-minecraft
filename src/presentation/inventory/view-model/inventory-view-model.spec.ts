...
import { InventoryViewModelLive, InventoryViewModelTag } from './inventory-view-model'
                    ...
                    Effect.gen(function* () {
                      ...
                      yield* Effect.forEach(toggles, (flag) =>
                        pipe(
                          flag,
                          Match.value,
                          Match.when(true, () => viewModel.handleEvent(playerId, InventoryOpened({}))),
                          Match.orElse(() => viewModel.handleEvent(playerId, InventoryClosed({})))
                        )
                      )
