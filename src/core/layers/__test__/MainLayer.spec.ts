...
describe('MainLayer', () => {
  ...
  it.effect('should be a composite layer including AppServiceLive', () => Effect.gen(function* () {
  ...
  it.effect('should be composable with other layers', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should be usable with Layer.use', () => Effect.gen(function* () {
    const result = Layer.launch(MainLayer)
    expect(Effect.isEffect(result)).toBe(true)
  })
)
    describe('Service Integration', () => {
  it.effect('should provide multiple services including AppService', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should maintain all Layer properties', () => Effect.gen(function* () {
  ...
  it.effect('should satisfy Layer type constraints', () => Effect.gen(function* () {
  ...
  it.effect('should be a properly structured composite layer', () => Effect.gen(function* () {
  ...
  it.effect('should initialize without errors', () => Effect.gen(function* () {
    const program = Effect.gen(function* () {
    const service = yield* AppService
    return service
    }).pipe(Effect.provide(MainLayer))
  ...
  Effect.gen(function* () {
    ...
    it.effect('should handle multiple sequential operations', () => Effect.gen(function* () {
    const program = Effect.gen(function* () {
    const service = yield* AppService
    // Multiple operations
