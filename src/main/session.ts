...
import { ParticleSystemService } from '@/infrastructure/three/particles/particle-system'
import { installPerfHudCounters } from '@/infrastructure/perf/perf-hud'
...
import { DebugOverlayService } from '@/presentation/hud/debug-overlay'
import { LoadingScreenService } from '@/presentation/loading/loading-screen'
...
import { DeathScreenService } from '@/presentation/menu/death-screen'
...
import { GameModeService, type GameMode } from '@/application/game-mode'
...
import type { BootContext } from '@/main/boot'
...
export const sessionProgram = (
  ...
  Effect.gen(function* () {
    ...
    // TODO(P1-W2c): mount DeathScreen — driven by HealthService.isDead().
    // TODO(P1-W3b): mount ParticleSystem (block-break InstancedMesh pool).
