...
// Spatial Grid Adapter - Functional with Context.GenericTag
export { 
  SpatialGridAdapter, 
  SpatialGridAdapterLive, 
  SpatialGridAdapterUtils,
  type SpatialGridAdapter as ISpatialGridAdapter,
} from '@infrastructure/adapters/spatial-grid.adapter'

// Material Manager Adapter - Functional with Context.GenericTag
export { 
  MaterialManagerAdapter, 
  MaterialManagerAdapterLive, 
  MaterialManagerAdapterUtils,
  type MaterialManagerAdapter as IMaterialManagerAdapter,
} from '@infrastructure/adapters/material-manager.adapter'
