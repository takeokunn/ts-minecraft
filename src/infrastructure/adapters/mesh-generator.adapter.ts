 ...
 */
const interleaveVertexAttributes = (
 ...
 */
export const createMeshGeneratorAdapter = () => Effect.gen(function* () {
   ...
   */
  const applyInfrastructureOptimizations = (
 ...
 */
export const MeshGeneratorAdapterLive = Layer.effect(
  MeshGeneratorPort,
 ...
 */
export const createCustomMeshGeneratorAdapter = (config?: {
