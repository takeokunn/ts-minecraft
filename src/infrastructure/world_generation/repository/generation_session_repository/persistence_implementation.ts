...
export const GenerationSessionRepositoryPersistenceLive = (config?: SessionPersistenceConfig) =>
  config ? GenerationSessionRepositoryPersistenceWith(config) : GenerationSessionRepositoryPersistence
