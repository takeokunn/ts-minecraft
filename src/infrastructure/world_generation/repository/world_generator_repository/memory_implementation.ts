...
export const WorldGeneratorRepositoryMemoryLive = (config?: WorldGeneratorRepositoryConfig) =>
  config ? WorldGeneratorRepositoryMemoryWith(config) : WorldGeneratorRepositoryMemory
