...
const runEffect = <A, E>(effect: Effect.Effect<A, E>) => Effect.runSyncExit.effect(effect)

// ========================================
// Tests
// ========================================

describe('AmbientOcclusion', () => Effect.gen(function* () {
    describe('Type Guards and Interfaces', () => {
    it.effect('should create valid AOVertex objects', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should create valid AOConfig', () => Effect.gen(function* () {
  ...
  it.effect('should blend AO colors correctly', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should get correct AO quality settings', () => Effect.gen(function* () {
  ...
  it.effect('should create AmbientOcclusionError with correct properties', () => Effect.gen(function* () {
