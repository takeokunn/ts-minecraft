...
describe('TextureAtlas', () => {
  ...
  it.effect('should validate TextureRegion schema', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should validate BlockTexture schema', () => Effect.gen(function* () {
  ...
  it.effect('should create valid TextureRegion objects', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should handle both filtering modes', () => Effect.gen(function* () {
  ...
  it.effect('should calculate atlas efficiency correctly', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should round to power of 2', () => Effect.gen(function* () {
  ...
  it.effect('should create TextureAtlasError with correct properties', () => Effect.gen(function* () {
  ...
  it('should provide TextureAtlasLive layer', async () => {
    ...
    describe('Edge Cases', () => {
  it.effect('should handle zero-sized textures gracefully', () => Effect.gen(function* () {
