...
describe('GreedyMeshing', () => Effect.gen(function* () {
    describe('Type Guards and Interfaces', () => {
    it.effect('should create valid Quad objects', () => Effect.gen(function* () {
    const quad: Quad = {
    x: 0,
    y: 0,
    z: 0,
  ...
  Effect.gen(function* () {
    ...
    it.effect('should handle all optimization levels', () => Effect.gen(function* () {
  ...
  it.effect('should calculate vertex reduction correctly', () => Effect.gen(function* () {
  ...
  it.effect('should create GreedyMeshingError with correct properties', () => Effect.gen(function* () {
