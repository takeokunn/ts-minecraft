import type { Inventory } from '@domain/inventory/inventory-types'
import { InventorySchema, PlayerIdSchema } from '@domain/inventory/inventory-types'
...
const TestLayer = Layer.mergeAll(LocalStorageInventoryService)
