 ...
 */
function naiveMeshing(chunkData: ChunkData, neighbors?: any): {
  positions: number[]
  normals: number[]
  uvs: number[]
  indices: number[]
 ...
 */
function greedyMeshing(chunkData: ChunkData, neighbors?: any): {
  positions: number[]
  normals: number[]
  uvs: number[]
  indices: number[]
...
const meshGenerationHandler = (
  ...
  Effect.gen(function* () {
    ...
    const vertexAttributes = createTransferableVertexData(
      meshData.positions,
