 ...
 */
const createThreeJSMaterial = (config: MaterialConfig, variant?: MaterialVariant): THREE.Material => {
...
export type { MaterialManagerState, MaterialConfig, MaterialVariant, EnhancedMaterial, WebGPUMaterial }
