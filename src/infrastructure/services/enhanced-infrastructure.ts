 ...
 */
export const WorldGenerationInfrastructureLayer = Layer.mergeAll(INFRASTRUCTURE_CONFIG.ENABLE_TERRAIN_GENERATOR_ENHANCEMENT ? EnhancedTerrainGeneratorLive : Layer.empty)
 ...
 */
export const EnhancedInfrastructureLayer = Layer.mergeAll(CoreInfrastructureLayer, RenderingInfrastructureLayer, WorldGenerationInfrastructureLayer, PerformanceInfrastructureLayer)
...
).pipe(Layer.provide(EnhancedInfrastructureLayer))
