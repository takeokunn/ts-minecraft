...
import { RendererLive, InputManagerLive, ClockLive, StatsLive, MaterialManagerLive, WorkerManagerLive, TerrainGeneratorLive } from './index'
...
).pipe(Layer.provide(EnhancedCoreServicesLive))
 ...
 */
export const TestEnhancedLive = Layer.mergeAll(EnhancedCoreServicesLive, EnhancedWorldServicesLive)

/**
 * Headless layer for server/simulation
 * No rendering or input, optimized for computation
 */
export const HeadlessEnhancedLive = Layer.mergeAll(EnhancedCoreServicesLive, EnhancedWorldServicesLive, EnhancedWorkerServicesLive)
 ...
 */
export const HighPerformanceRenderingLive = Layer.mergeAll(EnhancedCoreServicesLive, EnhancedRenderingServicesLive, EnhancedWorldServicesLive)

/**
 * Compute-focused layer
 * Emphasizes WASM and worker performance
 */
export const ComputeOptimizedLive = Layer.mergeAll(EnhancedCoreServicesLive, EnhancedWorkerServicesLive, EnhancedWorldServicesLive)
...
export const LowMemoryLive = Layer.mergeAll(
  ...
  RendererLive,
).pipe(Layer.tap(Effect.log('Low memory configuration active - reduced cache sizes')))
