...
describe('ECS Components', () => {
  describe('PositionComponent', () => {
    ...
    it.effect('should validate numeric values', () =>
      Effect.gen(function* () {
        expect(() => {
    ...
    it.effect('should require all coordinates', () =>
      Effect.gen(function* () {
        expect(() => {
  ...
  describe('VelocityComponent', () => {
    it.effect('should create valid velocity component', () =>
      Effect.gen(function* () {
    ...
    it.effect('should require all velocity components', () =>
      Effect.gen(function* () {
        expect(() => {
