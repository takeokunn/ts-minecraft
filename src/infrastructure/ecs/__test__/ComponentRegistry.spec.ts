...
describe('ECS Component Registry', () => {
  ...
  it.effect('should create empty registry', () => Effect.gen(function* () {
    const registry = {}
  ...
  Effect.gen(function* () {
    ...
    it.effect('should create registry with velocity component', () => Effect.gen(function* () {
    const registry = {
    ...
    it.effect('should create registry with both components', () => Effect.gen(function* () {
    const registry = {
    position: { x: 10, y: 20, z: 30 },
    velocity: { vx: 1.5, vy: -0.5, vz: 2.0 },
    const result = Schema.decodeUnknownSync(ComponentRegistry)(registry)
...
).toEqual({ vx: 1.5, vy: -0.5, vz: 2.0 })

      })
    it.effect('should be serializable to JSON', () => Effect.gen(function* () {
    const registry = {
  ...
  it.effect('should decode position component', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should reject invalid component', () => Effect.gen(function* () {
    expect(() => {
