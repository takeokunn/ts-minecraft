...
describe('SystemRegistry ECS Architecture', () => {
  describe('システム登録', () => {
  it.effect('システムを登録できる', () => Effect.gen(function* () {
    ...
    it.effect('同じ名前のシステムは重複登録されない', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    it.effect('異なる優先度でシステムを登録できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    it.effect('同じ優先度内でorder値によってソートされる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    describe('システム削除', () => {
    it.effect('登録されたシステムを削除できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    const testSystem = createSystem('TestSystem', () => Effect.void)
    ...
    it.effect('存在しないシステムの削除でエラーが発生する', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    const result = yield* Effect.exit.effect(registry.unregister('NonExistentSystem'))
    ...
    describe('システムの有効/無効', () => Effect.gen(function* () {
    it.effect('システムを無効化できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    let executed = false
    ...
    it.effect('システムを再度有効化できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    describe('優先度変更', () => {
  it.effect('システムの優先度を変更できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    const system1 = createSystem('System1', () => Effect.void)
    const system2 = createSystem('System2', () => Effect.void)
    ...
    it.effect('システムの実行順序を変更できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    const system1 = createSystem('System1', () => Effect.void)
    const system2 = createSystem('System2', () => Effect.void)
    yield* registry.register(system1, 'normal', 100)
    ...
    describe('システム実行', () => {
    it.effect('有効なシステムのみを実行する', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    it.effect('グローバルな有効/無効状態を制御できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    let executed = false
    const testSystem = createSystem('TestSystem', (
    }),
    ...
    it.effect('システムエラーを適切に処理する', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    describe('実行統計', () => {
    it.effect('システムの実行統計を取得できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    let executionCount = 0
    const testSystem = createSystem('TestSystem', (
    }),
    ...
    it.effect('存在しないシステムの統計取得でエラーが発生する', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    it.effect('エラー履歴が記録される', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    let failCount = 0
    const unreliableSystem = createSystem('UnreliableSystem', () => Effect.gen(function* () {
    failCount++
    if (failCount % 2 === 1) {
    ...
    it.effect('非SystemErrorのエラーが適切に記録される', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    it.effect('レジストリをクリアできる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
    ...
    it.effect('クリア後も新しいシステムを登録できる', () => Effect.gen(function* () {
    const registry = yield* SystemRegistryService
