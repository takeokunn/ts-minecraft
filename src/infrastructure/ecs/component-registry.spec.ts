...
import { ComponentRegistryLive, ComponentRegistryService } from './component-registry'

const provideRegistry = <A, E>(effect: Effect.Effect<A, E>) => provideLayers(effect, ComponentRegistryLive)
