...
describe('ErrorReporter', () => {
  describe('format', () => {
    ...
    it.effect('複雑なタグ付きエラーを完全にフォーマットする', () =>
      Effect.gen(function* () {
        const error = NetworkError({
