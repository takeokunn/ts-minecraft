...
describe('NetworkErrors', () => {
  describe('NetworkError', () => {
    it.effect('should create a basic network error', () =>
      Effect.gen(function* () {
  ...
  describe('ConnectionError', () => {
    it.effect('should track connection attempts', () =>
      Effect.gen(function* () {
  ...
  describe('TimeoutError', () => {
    it.effect('should track timeout details', () =>
      Effect.gen(function* () {
  ...
  describe('ProtocolError', () => {
    it.effect('should track protocol mismatches', () =>
      Effect.gen(function* () {
  ...
  describe('AuthenticationError', () => {
    it.effect('should track authentication failures', () =>
      Effect.gen(function* () {
  ...
  describe('SessionError', () => {
    it.effect('should track session issues', () =>
      Effect.gen(function* () {
  ...
  describe('SyncError', () => {
    it.effect('should track synchronization conflicts', () =>
      Effect.gen(function* () {
  ...
  describe('RateLimitError', () => {
    it.effect('should track rate limiting', () =>
      Effect.gen(function* () {
  ...
  describe('WebSocketError', () => {
    it.effect('should track WebSocket errors', () =>
      Effect.gen(function* () {
  ...
  describe('PacketError', () => {
    it.effect('should track packet processing errors', () =>
      Effect.gen(function* () {
  ...
  describe('ServerError', () => {
    it.effect('should track server-side errors', () =>
      Effect.gen(function* () {
  ...
  describe('P2PError', () => {
    it.effect('should track P2P connection errors', () =>
      Effect.gen(function* () {
