...
describe('NetworkErrors', () => {
  ...
  it.effect('should create a basic network error', () => Effect.gen(function* () {
    ...
    const result = await Effect.runPromiseExit.effect(program)
    expect(Exit.isFailure(result)).toBe(true)
    if (Exit.isFailure(result)) {
    const error = result.cause._tag === 'Fail' ? result.cause.error : null
    expect(error?._tag).toBe('NetworkError')
    describe('ConnectionError', () => Effect.gen(function* () {
    it.effect('should track connection attempts', () => Effect.gen(function* () {
  ...
  it.effect('should track timeout details', () => Effect.gen(function* () {
    ...
    it.effect('should track protocol mismatches', () => Effect.gen(function* () {
    ...
    it.effect('should track authentication failures', () => Effect.gen(function* () {
    ...
    it.effect('should track session issues', () => Effect.gen(function* () {
    ...
    describe('SyncError', () => {
    it.effect('should track synchronization conflicts', () => Effect.gen(function* () {
    ...
    it.effect('should track rate limiting', () => Effect.gen(function* () {
    ...
    it.effect('should track WebSocket errors', () => Effect.gen(function* () {
    ...
    it.effect('should track packet processing errors', () => Effect.gen(function* () {
    ...
    it.effect('should track server-side errors', () => Effect.gen(function* () {
  ...
  it.effect('should track P2P connection errors', () => Effect.gen(function* () {
