...
describe('GameErrors', () => {
  describe('GameError', () => {
  it.effect('should create a basic game error', () => Effect.gen(function* () {
    ...
    expect(error?._tag).toBe('GameError')
    it('should be validated by Schema', () => Effect.gen(function* () {
    const error = GameError({
    ...
    it.effect('should track state transitions', () => Effect.gen(function* () {
  ...
  it.effect('should track missing resources', () => Effect.gen(function* () {
    ...
    it.effect('should track validation failures', () => Effect.gen(function* () {
  ...
  it.effect('should track performance issues', () => Effect.gen(function* () {
    ...
    it.effect('should track configuration errors', () => Effect.gen(function* () {
    ...
    it.effect('should track rendering errors', () => Effect.gen(function* () {
  ...
  it.effect('should track world generation failures', () => Effect.gen(function* () {
    ...
    it.effect('should track entity errors', () => Effect.gen(function* () {
  ...
  it.effect('should track physics calculation errors', () => Effect.gen(function* () {
