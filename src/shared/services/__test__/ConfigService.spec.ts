...
describe('ConfigService', () => {
  ...
  it.effect('should handle invalid config key in updateConfig', () => Effect.gen(function* () {
    ...
    it.effect('should provide default game configuration', () => Effect.gen(function* () {
    const service = yield* ConfigService
    ...
    it.effect('should provide default render configuration', () => Effect.gen(function* () {
    const service = yield* ConfigService
    ...
    it.effect('should provide default debug configuration', () => Effect.gen(function* () {
    const service = yield* ConfigService
    ...
    it.effect('should get configuration by key', () => Effect.gen(function* () {
    const service = yield* ConfigService
    ...
    it.effect('should update configuration', () => Effect.gen(function* () {
    const service = yield* ConfigService
    ...
    it.effect('should update render configuration', () => Effect.gen(function* () {
    const service = yield* ConfigService
    ...
    it.effect('should provide test configuration with debug enabled', () => Effect.gen(function* () {
    const service = yield* ConfigService
    const debugConfig = service.debugConfig
    expect(debugConfig.enabled).toBe(true)
}).pipe(Effect.provide(ConfigServiceTest))
    )
    it.effect('should return configs via getConfig method', () => Effect.gen(function* () {
    const service = yield* ConfigService
    const gameConfig = yield* service.getConfig('gameConfig')
    const renderConfig = yield* service.getConfig('renderConfig')
    expect(gameConfig.fps).toBe(60)
    ...
    it.effect('should handle debug config updates', () => Effect.gen(function* () {
    const service = yield* ConfigService
    ...
    it.effect('should validate GameConfig schema', () => Effect.gen(function* () {
    const validConfig = {
    fps: 60,
    tickRate: 20,
    renderDistance: 8,
    ...
    it.effect('should reject invalid FPS values', () => Effect.gen(function* () {
    const invalidConfig = {
    fps: 200, // 144以上は無効
    tickRate: 20,
    renderDistance: 8,
    ...
    it.effect('should validate RenderConfig schema', () => Effect.gen(function* () {
    const validConfig = {
    resolution: { width: 1920, height: 1080 },
    ...
    it.effect('should reject invalid quality values', () => Effect.gen(function* () {
    const invalidConfig = {
    resolution: { width: 1920, height: 1080 },
    ...
    it.effect('should validate DebugConfig schema', () => Effect.gen(function* () {
    const validConfig = {
    enabled: true,
    showFps: true,
    showChunkBorders: false,
    ...
    it.effect('should reject invalid log levels', () => Effect.gen(function* () {
    const invalidConfig = {
    enabled: true,
    showFps: true,
    showChunkBorders: false,
    ...
    it.effect('should reject negative resolution values', () => Effect.gen(function* () {
    const invalidConfig = {
    resolution: { width: -1920, height: 1080 },
    quality: 'high' as const,
    shadows: true,
    ...
    it.effect('should validate FOV within bounds', () => Effect.gen(function* () {
    const validFov = {
    resolution: { width: 1920, height: 1080 },
    quality: 'high' as const,
    shadows: true,
