...
const validateTradeConditions = (operation: TradeOperation, validationService: ValidationService) => Effect.void
const reserveTradeItems = (offers: any[], inventoryService: InventoryService) => Effect.succeed([])
const rollbackTradeItems = (items: any[], inventoryService: InventoryService) => Effect.void
...
const validateTargetCapacities = (plan: any[], service: any) => Effect.void
