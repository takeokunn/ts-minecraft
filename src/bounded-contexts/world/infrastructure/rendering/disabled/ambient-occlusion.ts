import { AOValue, BrandedTypes } from '@mc/bc-world/infrastructure/rendering/disabled/types/index'
import { Array as A, Context, Effect, Layer, Match, Number as N, Option, pipe, Predicate } from 'effect'
import type { ChunkDataAggregate } from '../../domain/chunk'
import type { BlockType } from './mesh-generator'
...
export interface AmbientOcclusionService {
  ...
  readonly applyAOToChunk: (
    chunkData: ChunkDataAggregate
  ) => Effect.Effect<readonly AOVertex[], AmbientOcclusionError, never>
}
