 ...
 * ## 使用例
 * ```typescript
 * import { GenerationSessionFactory } from './generation-session-factory'
 *
 * // ファクトリ使用
...
import { createSessionBuilder } from './session-builder.js'
import { createOptimizedConfiguration } from './configuration.js'
import { getTemplate } from './template-resolver.js'
...
export type {
  ...
  GenerationRequest,
} from '../../aggregate/generation_session/generation-session.js'
