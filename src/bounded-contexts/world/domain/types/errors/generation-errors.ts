...
import { ErrorContext } from './world-errors'
import {
  GenerationSessionId,
  GenerationRequestId,
  GenerationStage,
...
export const ChunkGenerationErrorSchema = Schema.TaggedStruct('ChunkGenerationError', {
  ...
  context: Schema.suspend(() => import('./world-errors').then(m => m.ErrorContextSchema)),
...
export const GenerationSessionErrorSchema = Schema.TaggedStruct('GenerationSessionError', {
  ...
  activeRequests: Schema.Array(Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationRequestIdSchema))),
  reason: Schema.String,
  context: Schema.suspend(() => import('./world-errors').then(m => m.ErrorContextSchema)),
...
export const InvalidNoiseParametersErrorSchema = Schema.TaggedStruct('InvalidNoiseParametersError', {
  parameters: Schema.suspend(() => import('../core/generation-types').then(m => m.NoiseParametersSchema)),
  invalidFields: Schema.Array(Schema.String),
  reason: Schema.String,
  context: Schema.suspend(() => import('./world-errors').then(m => m.ErrorContextSchema)),
  suggestedFix: Schema.optional(Schema.suspend(() => import('../core/generation-types').then(m => m.NoiseParametersSchema))),
}).pipe(
  Schema.annotations({
...
export const GenerationDependencyErrorSchema = Schema.TaggedStruct('GenerationDependencyError', {
  requiredStage: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationStageSchema)),
  currentStage: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationStageSchema)),
  chunkPosition: Schema.suspend(() => import('../core/generation-types').then(m => m.ChunkPositionSchema)),
  context: Schema.suspend(() => import('./world-errors').then(m => m.ErrorContextSchema)),
...
export const GenerationErrorSchema = Schema.TaggedStruct('GenerationError', {
  ...
  context: Schema.optional(Schema.suspend(() => import('./world-errors').then(m => m.ErrorContextSchema))),
}).pipe(
  Schema.annotations({
