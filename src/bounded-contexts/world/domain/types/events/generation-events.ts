...
import { EventMetadata } from './world-events'
import {
  GenerationSessionId,
  GenerationRequestId,
  GenerationStage,
...
export const GenerationSessionStartedEventSchema = Schema.Struct({
  ...
  metadata: Schema.suspend(() => import('./world-events').then(m => m.EventMetadataSchema)),
  payload: Schema.Struct({
    sessionId: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationSessionIdSchema)),
...
export const GenerationSessionCompletedEventSchema = Schema.Struct({
  ...
  payload: Schema.Struct({
    ...
    performanceStats: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationPerformanceStatsSchema)),
  }),
}).pipe(
  Schema.annotations({
...
export const GenerationSessionFailedEventSchema = Schema.Struct({
  ...
  payload: Schema.Struct({
    ...
    failedChunks: Schema.Array(Schema.suspend(() => import('../core/generation-types').then(m => m.ChunkPositionSchema))),
...
export const ChunkGenerationStartedEventSchema = Schema.Struct({
  ...
  metadata: Schema.suspend(() => import('./world-events').then(m => m.EventMetadataSchema)),
  payload: Schema.Struct({
    requestId: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationRequestIdSchema)),
    chunkPosition: Schema.suspend(() => import('../core/generation-types').then(m => m.ChunkPositionSchema)),
    priority: Schema.Number.pipe(Schema.int(), Schema.between(0, 10)),
    requestedBy: Schema.String,
    expectedStages: Schema.Array(Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationStageSchema))),
  }),
}).pipe(
  Schema.annotations({
...
export const ChunkGenerationCompletedEventSchema = Schema.Struct({
  ...
  payload: Schema.Struct({
    ...
    completedStages: Schema.Array(Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationStageSchema))),
    heightMap: Schema.suspend(() => import('../core/generation-types').then(m => m.HeightMapSchema)),
    biomeData: Schema.suspend(() => import('../core/generation-types').then(m => m.BiomeGenerationDataSchema)),
...
export const ChunkGenerationFailedEventSchema = Schema.Struct({
  ...
  payload: Schema.Struct({
    requestId: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationRequestIdSchema)),
    chunkPosition: Schema.suspend(() => import('../core/generation-types').then(m => m.ChunkPositionSchema)),
    failedStage: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationStageSchema)),
    reason: Schema.String,
...
export const GenerationStageStartedEventSchema = Schema.Struct({
  ...
  payload: Schema.Struct({
    requestId: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationRequestIdSchema)),
    chunkPosition: Schema.suspend(() => import('../core/generation-types').then(m => m.ChunkPositionSchema)),
    stage: Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationStageSchema)),
    estimatedDuration: Schema.optional(Schema.Number.pipe(Schema.nonNegative())),
    dependencies: Schema.Array(Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationStageSchema))),
  }),
}).pipe(
  Schema.annotations({
...
export const GenerationStageCompletedEventSchema = Schema.Struct({
  ...
  payload: Schema.Struct({
    ...
    nextStages: Schema.Array(Schema.suspend(() => import('../core/generation-types').then(m => m.GenerationStageSchema))),
  }),
}).pipe(
  Schema.annotations({
...
export const StructurePlacedEventSchema = Schema.Struct({
  ...
  payload: Schema.Struct({
    chunkPosition: Schema.suspend(() => import('../core/generation-types').then(m => m.ChunkPositionSchema)),
    structure: Schema.suspend(() => import('../core/generation-types').then(m => m.StructureInfoSchema)),
