...
import { BIOME_CONSTANTS } from '../constants/biome-constants'
import { BlockPosition, CircularArea, RectangularArea } from './coordinate-types'
...
export const BiomeTransitionRuleSchema = Schema.Struct({
  from: BiomeIdSchema,
  to: BiomeIdSchema,
  transitionZone: Schema.suspend(() => import('./coordinate-types').then(m => m.RectangularAreaSchema)),
