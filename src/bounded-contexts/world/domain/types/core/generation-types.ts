...
import { GENERATION_CONSTANTS } from '../constants/generation-constants'
import { ChunkPosition, Vector3D, WorldSeed } from './world-types'
...
export const HeightMapSchema = Schema.Struct({
  chunkPosition: Schema.suspend(() => import('./world-types').then(m => m.ChunkPositionSchema)),
...
export const GenerationSettingsSchema = Schema.Struct({
  seed: Schema.suspend(() => import('./world-types').then(m => m.WorldSeedSchema)),
...
export const StructureInfoSchema = Schema.Struct({
  ...
  position: Schema.suspend(() => import('./world-types').then(m => m.Vector3DSchema)),
...
export const BoundingBoxSchema = Schema.Struct({
  min: Schema.suspend(() => import('./world-types').then(m => m.Vector3DSchema)),
  max: Schema.suspend(() => import('./world-types').then(m => m.Vector3DSchema)),
}).pipe(
  Schema.annotations({
    title: 'Bounding Box',
...
export const GenerationContextSchema = Schema.Struct({
  ...
  completedChunks: Schema.Array(Schema.suspend(() => import('./world-types').then(m => m.ChunkPositionSchema))),
}).pipe(
  Schema.annotations({
