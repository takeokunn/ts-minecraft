...
export const normalizePattern = (pattern: RecipePattern): { width: number; height: number; slots: (string | null)[][] } => {
...
export const extractItemsFromGrid = (grid: CraftingGrid): CraftingItemStack[] => {
...
export const checkPatternMatchSync = (
...
export const matchesIngredient = (
...
export const checkShapelessMatch = (items: CraftingItemStack[], requiredIngredients: ItemMatcher[]): boolean => {
...
export const consumeShapedIngredients = (
  grid: CraftingGrid,
  recipe: ShapedRecipe
...
export const consumeShapelessIngredients = (
  grid: CraftingGrid,
...
export const rotate90 = (pattern: { width: number; height: number; slots: (string | null)[][] }): typeof pattern => ({
...
export const rotate180 = (pattern: { width: number; height: number; slots: (string | null)[][] }): typeof pattern =>
  rotate90(rotate90(pattern))

export const rotate270 = (pattern: { width: number; height: number; slots: (string | null)[][] }): typeof pattern =>
  rotate90(rotate180(pattern))

export const flipHorizontal = (pattern: { width: number; height: number; slots: (string | null)[][] }): typeof pattern => ({
  ...pattern,
  slots: pattern.slots.map((row) => [...row].reverse()),
})

export const flipVertical = (pattern: { width: number; height: number; slots: (string | null)[][] }): typeof pattern => ({
  ...pattern,
  slots: [...pattern.slots].reverse(),
})

export const gridToString = (grid: CraftingGrid): string => {
  return grid.slots.map((row) => row.map((slot) => (slot ? slot.itemId : '_')).join('|')).join('#')
}

export const recipeToString = (recipe: CraftingRecipe): string => {
