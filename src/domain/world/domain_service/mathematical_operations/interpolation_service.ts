...
export const InterpolationService = Context.GenericTag<InterpolationService>('@minecraft/domain/world/Interpolation')

export const InterpolationServiceLive = Layer.effect(
