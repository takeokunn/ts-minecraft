...
describe('domain/world/layers', () => {
  it.effect('default layer composes successfully', () =>
    Effect.gen(function* () {
      ...
      const result = yield* Effect.provide(Effect.unit, layer)
  ...
  it.effect('performance layer disables validation services', () =>
    Effect.gen(function* () {
      ...
      const result = yield* Effect.provide(Effect.unit, WorldDomainPerformanceLayer)
      expect(result).toBeUndefined()
    })
  )
  ...
  it.effect('quality layer enables validation services', () =>
    Effect.gen(function* () {
      ...
      const result = yield* Effect.provide(Effect.unit, WorldDomainQualityLayer)
      expect(result).toBeUndefined()
    })
  )
  ...
  it.effect('test layer remains lightweight', () =>
    Effect.gen(function* () {
      const result = yield* Effect.provide(Effect.unit, WorldDomainTestLayer)
      expect(result).toBeUndefined()
    })
  )
})
