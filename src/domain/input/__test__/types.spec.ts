...
describe('Input Types', () => {
  describe('MouseDelta', () => {
  it.effect('should validate valid mouse delta', () => Effect.gen(function* () {
    const validDelta = {
    deltaX: 10.5,
    deltaY: -5.2,
  ...
  Effect.gen(function* () {
    ...
    it.effect('should reject zero timestamp', () => Effect.gen(function* () {
    const invalidDelta = {
    deltaX: 10.5,
    deltaY: -5.2,
    timestamp: 0,
    ...
    describe('KeyState', () => {
  it.effect('should validate valid key state', () => Effect.gen(function* () {
    const validKeyState = {
    key: 'w',
    isPressed: true,
    timestamp: 1234567890,
  ...
  Effect.gen(function* () {
    ...
    it.effect('should validate multi-character keys', () => Effect.gen(function* () {
    const validKeyState = {
    key: 'Space',
    isPressed: false,
    timestamp: 1234567890,
  ...
  it.effect('should validate valid mouse button states', () => Effect.gen(function* () {
  ...
  it.effect('should validate all valid input event types', () => Effect.gen(function* () {
    ...
    it.effect('should reject invalid event types', () => Effect.gen(function* () {
    const invalidTypes = ['click', 'hover', 'scroll', '', null, undefined]
    invalidTypes.forEach((type) => {
    expect(() => Schema.decodeUnknownSync(InputEventType)(type)).toThrow()
    )
    describe('InputEvent', () => {
    it.effect('should validate key event', () => Effect.gen(function* () {
    const validKeyEvent = {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should validate mouse move event', () => Effect.gen(function* () {
    ...
    it.effect('should validate minimal event', () => Effect.gen(function* () {
  ...
  it.effect('should create input system error correctly', () => Effect.gen(function* () {
    ...
    it.effect('should create error with button', () => Effect.gen(function* () {
    const error = InputSystemError({
