...
describe('KeyMapping', () => {
  ...
  describe('KeyMappingConfig Schema', () => {
    ...
    it.effect('追加のキーがある設定を許容する（Schema.Structのデフォルト動作）', () =>
      Effect.gen(function* () {
        const extraConfig = {
          ...DefaultKeyMap,
          extraKey: 'X', // 余分なキー
  ...
  describe('DefaultKeyMap', () => {
    it.effect('すべての必要なアクションが定義されている', () =>
      Effect.gen(function* () {
    ...
    it.effect('KeyMappingConfig Schemaに準拠している', () =>
      Effect.gen(function* () {
  ...
  describe('CustomKeyMapping Schema', () => {
    ...
    it.effect('createdAtとupdatedAtの関係性を検証する', () =>
      Effect.gen(function* () {
  ...
  describe('KeyMappingError', () => {
    ...
    it.effect('オプショナルなフィールドなしでエラーを作成できる', () =>
      Effect.gen(function* () {
        const error = KeyMappingError({
          message: 'エラーメッセージ',
        })
    ...
    it.effect('KeyMappingErrorSchema に準拠している', () =>
      Effect.gen(function* () {
        const error = KeyMappingError({
          message: 'スキーマテスト',
          action: 'jump',
