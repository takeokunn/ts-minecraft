...
import { Effect, Function, Match, Option, pipe, Schema } from 'effect'
...
const getCategoryDefaultConfig = (category: ItemCategory): ItemBuilderConfig =>
  pipe(
    ...
    Match.value,
    Match.when('tool', () => ({
      category: Schema.make(ItemCategorySchema)('tool'),
      stackable: false,
      maxStackSize: 1,
      durability: 1.0,
      maxDurability: 100,
      quality: Schema.make(ItemQualitySchema)('common'),
      rarity: Schema.make(ItemRaritySchema)('common'),
      count: 1,
    })),
    Match.when('weapon', () => ({
      category: Schema.make(ItemCategorySchema)('weapon'),
      stackable: false,
      maxStackSize: 1,
      durability: 1.0,
      maxDurability: 150,
    ...
    Match.when('armor', () => ({
      category: Schema.make(ItemCategorySchema)('armor'),
      stackable: false,
      maxStackSize: 1,
      durability: 1.0,
      maxDurability: 200,
    ...
    Match.when('food', () => ({
      category: Schema.make(ItemCategorySchema)('food'),
      stackable: true,
      maxStackSize: 16,
      quality: Schema.make(ItemQualitySchema)('common'),
      rarity: Schema.make(ItemRaritySchema)('common'),
    ...
    Match.when('block', () => ({
      category: Schema.make(ItemCategorySchema)('block'),
      stackable: true,
      maxStackSize: 64,
      quality: Schema.make(ItemQualitySchema)('common'),
      rarity: Schema.make(ItemRaritySchema)('common'),
    ...
    Match.when('resource', () => ({
      category: Schema.make(ItemCategorySchema)('resource'),
      stackable: true,
      maxStackSize: 64,
      quality: Schema.make(ItemQualitySchema)('common'),
      rarity: Schema.make(ItemRaritySchema)('common'),
    ...
    Match.when('consumable', () => ({
      category: Schema.make(ItemCategorySchema)('consumable'),
      stackable: true,
      maxStackSize: 8,
      quality: Schema.make(ItemQualitySchema)('common'),
      rarity: Schema.make(ItemRaritySchema)('common'),
    ...
    Match.when('redstone', () => ({
      category: Schema.make(ItemCategorySchema)('redstone'),
      stackable: true,
      maxStackSize: 64,
      quality: Schema.make(ItemQualitySchema)('common'),
      rarity: Schema.make(ItemRaritySchema)('common'),
    ...
    Match.when('decoration', () => ({
      category: Schema.make(ItemCategorySchema)('decoration'),
      stackable: true,
      maxStackSize: 64,
      quality: Schema.make(ItemQualitySchema)('common'),
      rarity: Schema.make(ItemRaritySchema)('common'),
    ...
    Match.when('misc', () => ({
      category: Schema.make(ItemCategorySchema)('misc'),
      stackable: true,
      maxStackSize: 64,
      quality: Schema.make(ItemQualitySchema)('common'),
      rarity: Schema.make(ItemRaritySchema)('common'),
