...
export interface ItemRegistryService {
  ...
  readonly getDefinitionsByCategory: (category: ItemCategory) => Effect.Effect<ReadonlyArray<ItemDefinition>>
...
const ItemRegistryTag = Context.GenericTag<ItemRegistryService>('@minecraft/domain/inventory/ItemRegistry')
