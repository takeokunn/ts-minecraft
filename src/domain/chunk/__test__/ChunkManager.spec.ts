...
describe('LRU Cache Functions', () => {
  ...
  describe('lruGet', () => {
    it.effect('存在しないキーに対してundefinedを返す', () =>
      Effect.gen(function* () {
        const cache = createLRUCache<string, number>(5)
    ...
    it.effect('存在するキーの値を返し、アクセス順を更新する', () =>
      Effect.gen(function* () {
  ...
  describe('lruPut', () => {
    ...
    it.effect('容量制限を超えると最も古いエントリを削除する', () =>
      Effect.gen(function* () {
    ...
    it.effect('既存のキーを更新するとアクセス順のみ変更される', () =>
      Effect.gen(function* () {
        let cache = createLRUCache<string, number>(5)
        cache = lruPut(cache, 'a', 1)
        cache = lruPut(cache, 'b', 2)
...
describe('Utility Functions', () => {
  ...
  describe('chunkDistance', () => {
    it.effect('チャンク間の距離を計算できる（チェビシェフ距離）', () =>
      Effect.gen(function* () {
...
describe('Edge Cases', () => {
  ...
  describe('Coordinate Edge Cases', () => {
    ...
    it.effect('小数点を含むワールド座標でも正しくチャンク座標に変換される', () =>
      Effect.gen(function* () {
