...
describe('ChunkPosition', () => {
  ...
  it.effect('should validate valid chunk positions', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should handle floating point numbers by accepting them', () => Effect.gen(function* () {
  ...
  it.effect('should convert chunk coordinates to block coordinates correctly', () => Effect.gen(function* () {
  ...
  it.effect('should convert block coordinates to chunk coordinates correctly', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
        ...
        expect(blockToChunkCoords(BrandedTypes.createWorldCoordinate(-1
    }),
    BrandedTypes.createWorldCoordinate(0))).toEqual(
        { x: -1, z: 0 }
        )
        expect(
    ...
    it.effect('should be inverse of chunkToBlockCoords', () => Effect.gen(function* () {
  ...
  it.effect('should generate unique IDs for chunk positions', () => Effect.gen(function* () {
  ...
  it.effect('should parse valid chunk IDs correctly', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
        ...
        it.effect('should be inverse of chunkPositionToId', () => Effect.gen(function* () {
    const positions: ChunkPosition[] = [
    { x: 0, z: 0 },
    { x: 42, z: -13 },
    { x: -100, z: 200 },
  ...
  it.effect('should return true for equal positions', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should be reflexive', () => Effect.gen(function* () {
    const positions: ChunkPosition[] = [
    { x: 0, z: 0 },
    { x: 42, z: -13 },
    { x: -999, z: 999 },
  ...
  it.effect('should calculate Manhattan distance correctly', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should return 0 for identical positions', () => Effect.gen(function* () {
    const positions: ChunkPosition[] = [
    { x: 0, z: 0 },
    { x: 42, z: -13 },
    { x: -999, z: 999 },
