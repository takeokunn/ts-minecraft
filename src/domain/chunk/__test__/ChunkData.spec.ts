...
describe('ChunkData', () => {
  ...
  describe('constants', () => {
  it.effect('should have correct chunk dimensions', () => Effect.gen(function* () {
    ...
    it.effect('should have consistent derived values', () => Effect.gen(function* () {
    ...
    it.effect('should validate correct metadata', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should reject negative light levels', () => Effect.gen(function* () {
    const invalidMetadata = {
    biome: 'plains',
  ...
  it.effect('should calculate correct indices for valid coordinates', () => Effect.gen(function* () {
    ...
    it.effect('should throw for out-of-bounds coordinates', () => Effect.gen(function* () {
    const invalidCases = [
    [-1, 0, 0], // X < 0
    [16, 0, 0], // X >= CHUNK_SIZE
  ...
  Effect.gen(function* () {
    ...
    it.effect('should generate indices within valid range', () => Effect.gen(function* () {
    for (
  ...
  }) {it.effect('should be inverse of getBlockIndex', () => Effect.gen(function* () {
    ...
    it.effect('should throw for invalid indices', () => Effect.gen(function* () {
    ...
    it.effect('should create chunk with default metadata', () => Effect.gen(function* () {
    ...
    it.effect('should create chunk with custom metadata', () => Effect.gen(function* () {
  ...
  describe('getBlock', () => {
  it.effect('should return Air (0) for newly created chunk', () => Effect.gen(function* () {
    const testCases: Array<[number, number, number]> = [
    [0, 0, 0],
    [15, 319, 15],
    [8, -64, 8],
    ...
    it.effect('should return correct block after setting', () => Effect.gen(function* () {
    ...
    describe('setBlock', () => {
    it.effect('should set block and return new chunk', () => Effect.gen(function* () {
    ...
    it.effect('should mark chunk as dirty and modified', () => Effect.gen(function* () {
    const newChunk = setBlock(
    testChunk,
    ...
    it.effect('should preserve other blocks', () => Effect.gen(function* () {
    let chunk = testChunk
    chunk = setBlock(
    chunk,
    ...
    it.effect('should update height at specified coordinates', () => Effect.gen(function* () {
    ...
    it.effect('should preserve other height values', () => Effect.gen(function* () {
    let chunk = testChunk
    ...
    describe('getHeight', () => {
    it.effect('should return 0 for newly created chunk', () => Effect.gen(function* () {
    for (
    for (let z = 0; z < CHUNK_SIZE; z++) {
    expect(
    getHeight(testChunk, BrandedTypes.createWorldCoordinate(x
    }),
    BrandedTypes.createWorldCoordinate(z))
    ).toBe(0)
    ) {$2
    ...
    describe('isEmpty', () => {
  it.effect('should return true for newly created chunk', () => Effect.gen(function* () {
    expect(isEmpty(testChunk)).toBe(true)
    )
    it.effect('should return false after setting any block', () => Effect.gen(function* () {
    const modifiedChunk = setBlock(
    testChunk,
    BrandedTypes.createWorldCoordinate(0),
    BrandedTypes.createWorldCoordinate(0),
    ...
    it.effect('should return true after setting block back to Air', () => Effect.gen(function* () {
    let chunk = setBlock(
    testChunk,
    BrandedTypes.createWorldCoordinate(5),
    BrandedTypes.createWorldCoordinate(100),
    ...
    it.effect('should calculate memory usage correctly', () => Effect.gen(function* () {
    ...
    it.effect('should be consistent across multiple calls', () => Effect.gen(function* () {
    ...
    it.effect('should reset chunk to empty state', () => Effect.gen(function* () {
    let chunk = setBlock(
    testChunk,
    BrandedTypes.createWorldCoordinate(1),
    BrandedTypes.createWorldCoordinate(1),
    ...
    chunk = updateHeightMap(chunk, BrandedTypes.createWorldCoordinate(5
    }),
    BrandedTypes.createWorldCoordinate(5), 150)
  ...
  Effect.gen(function* () {
        ...
        it.effect('should handle block operations efficiently', () => Effect.gen(function* () {
    ...
    it.effect('should maintain O(1) block access time', () => Effect.gen(function* () {
    ...
    it.effect('should handle full chunk population efficiently', () => Effect.gen(function* () {
    const start = performance.now()
    let chunk = testChunk
    ...
    it.effect('should maintain memory efficiency under load', () => Effect.gen(function* () {
    let chunk = testChunk
