...
import { PhysicsWorldAggregate } from '../aggregate/physics-world'
import { PhysicsSimulationService } from '../domain_service/physics-simulation-service'
...
export const PhysicsSimulationOrchestratorService = Context.GenericTag<PhysicsSimulationOrchestratorService>(
