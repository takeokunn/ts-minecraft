...
import { GravityVector } from '../value_object/gravity-vector'
import { FluidState } from '../value_object/fluid-state'
import { FrictionCoefficient } from '../value_object/friction-coefficient'
...
export const PhysicsSimulationService = Context.GenericTag<PhysicsSimulationService>(
