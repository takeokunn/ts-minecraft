...
import type { FluidState as FluidStateState } from '../value_object/fluid-state'
...
export const analyzeTerrain = (context: TerrainContext): TerrainAnalysis => ({
...
export const TerrainAdaptationServiceLive = Layer.succeed(TerrainAdaptationService, {
  analyze: (context) => Effect.succeed(analyzeTerrain(context)),
})
