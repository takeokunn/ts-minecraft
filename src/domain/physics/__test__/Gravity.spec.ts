...
describe('Gravity System', () => {
  ...
  describe('calculateJumpVelocity', () => {
    it('should calculate correct jump velocity for target height', () => {
    ...
    it('should scale with jump height', () => {
  ...
  describe('calculateFallDamage', () => {
    it('should not cause damage for falls under 3 blocks', () => {
    ...
    it('should calculate damage for falls over 3 blocks', () => {
