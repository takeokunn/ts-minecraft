...
import { BlockIdSchema, assembleIdentity, makeBlockId, makeBlockName, makeBlockPosition, makeBlockTag, makeBlockTags } from '../block-identity'
...
describe('block_identity', () => {
  ...
  it.prop('BlockIdSchemaに適合する文字列は必ず生成できる', [blockIdArbitrary], ([value]) => {
