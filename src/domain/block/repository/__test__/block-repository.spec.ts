...
import { makeBlockId } from '../../value_object/block-identity'
import { makeStandardBlock } from '../../types/block-definition'
import { BlockRepositoryError, makeInMemory } from '../block-repository'

const createBlock = (id: string, name: string, tags?: ReadonlyArray<string>) =>
  makeStandardBlock({ id, name, tags })
