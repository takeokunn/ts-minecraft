...
describe('BlockProperties', () => {
  ...
  describe('Physics modifiers', () => {
    ...
    it('withOpacityで不透明度を設定できる（0-15の範囲）', () => {
  ...
  describe('Texture modifiers', () => {
    ...
    it('withTexturePerFaceで既存テクスチャをデフォルトとして使用する', () => {
      const props = pipe(
        defaultBlockProperties,
        withTexture('oak_log'),
        withTexturePerFace({
  ...
  describe('Preset properties', () => {
    it('stonePropertiesが石のプリセットを提供する', () => {
    ...
    it('dirtPropertiesが土のプリセットを提供する', () => {
    ...
    it('woodPropertiesが木材のプリセットを提供する', () => {
    ...
    it('leavesPropertiesが葉のプリセットを提供する', () => {
    ...
    it('glassPropertiesがガラスのプリセットを提供する', () => {
    ...
    it('orePropertiesが鉱石のプリセットを提供する', () => {
    ...
    it('liquidPropertiesが液体のプリセットを提供する', () => {
    ...
    it('plantPropertiesが植物のプリセットを提供する', () => {
    ...
    it('unbreakablePropertiesが破壊不可のプリセットを提供する', () => {
    ...
    it('woolPropertiesが羊毛のプリセットを提供する', () => {
