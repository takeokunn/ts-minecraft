...
describe('BlockType', () => {
  describe('Branded Types', () => {
    it.scoped('BlockIdをBranded型として作成できる（Property-based）', () =>
      Effect.gen(function* () {
    ...
    it.scoped('TextureIdをBranded型として作成できる（Property-based）', () =>
      Effect.gen(function* () {
  ...
  describe('ToolTypeSchema', () => {
    it.scoped('有効なツールタイプを検証できる（Property-based）', () =>
      Effect.gen(function* () {
    ...
    it.scoped('生成されたツールタイプは常に有効（Schemaベース）', () =>
      Effect.gen(function* () {
        // 有効なツールタイプを使用したテスト
        const validTools = ['none', 'pickaxe', 'axe', 'shovel', 'hoe', 'shears', 'sword'] as const
    ...
    it.scoped('無効なツールタイプを拒否する（Property-based）', () =>
      Effect.gen(function* () {
  ...
  describe('TextureFacesSchema', () => {
    it.scoped('6面のテクスチャを定義できる（Property-based）', () =>
      Effect.gen(function* () {
        const testCases = [
          {
            top: 'grass_top',
    ...
    it.scoped('不完全なテクスチャ面定義を拒否する（Property-based）', () =>
      Effect.gen(function* () {
  ...
  describe('BlockTextureSchema', () => {
    it.scoped('単純なテクスチャ文字列を受け入れる（Property-based）', () =>
      Effect.gen(function* () {
    ...
    it.scoped('面別テクスチャオブジェクトを受け入れる（Property-based）', () =>
      Effect.gen(function* () {
        const testCases = [
          {
            top: 'grass_top',
  ...
  describe('ItemDropSchema', () => {
    it.scoped('アイテムドロップを定義できる（Property-based）', () =>
      Effect.gen(function* () {
        const testCases = [
    ...
    it.effect('確率が範囲外でも受け入れる（バリデーションは別レイヤー）', () =>
      Effect.gen(function* () {
        const itemDrop = {
          itemId: 'diamond',
          minCount: 1,
  ...
  describe('BlockPhysicsSchema', () => {
    ...
    it.effect('数値が範囲外でも受け入れる（バリデーションは別レイヤー）', () =>
      Effect.gen(function* () {
        const physics = {
          hardness: -1.0, // 破壊不可
  ...
  describe('BlockTypeSchema', () => {
    ...
    it.effect('必須フィールドが欠けている場合は拒否する', () =>
      Effect.gen(function* () {
  ...
  describe('Default Helpers', () => {
    it.effect('createDefaultPhysicsがデフォルト物理特性を返す', () =>
      Effect.gen(function* () {
    ...
    it.effect('createDefaultSoundがデフォルトサウンドを返す', () =>
      Effect.gen(function* () {
