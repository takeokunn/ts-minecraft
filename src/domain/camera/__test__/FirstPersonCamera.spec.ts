...
describe('FirstPersonCamera', () => {
  ...
  it.effect('should initialize camera with default settings', () => Effect.gen(function* () {
    ...
    it.effect('should validate configuration with property-based testing', () => Effect.gen(function* () {
    ...
    it.effect('should update camera position based on target position', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    it.effect('should apply smoothing to position updates', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    it.effect('should handle performance requirements for position updates', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    ...
    it.effect('should change yaw with horizontal mouse movement', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    const initialState = yield* service.getState()
    ...
    it.effect('should change pitch with vertical mouse movement', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    const initialState = yield* service.getState()
    ...
    it.effect('should clamp pitch within limits', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    ...
    it.effect('should apply sensitivity to rotation speed', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    it.effect('should normalize extreme rotation values', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    ...
    it.effect('should handle mode switching (first-person to first-person)', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({ ...DEFAULT_CAMERA_CONFIG, mode: 'first-person'
        ...
        it.effect('should apply configuration constraints', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    ...
    it.effect('should handle third-person distance (no effect in first-person)', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    ...
    it.effect('should handle third-person mode switching (no effect)', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    const config1 = yield* service.getConfig()
    ...
    it.effect('should preserve first-person mode when individually updating settings (lines 155-160)', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    // Verify initial mode
    const initialConfig = yield* service.getConfig()
    ...
    it.effect('should reset camera to initial state', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    const initialState = yield* service.getState()
    // Make changes
    ...
    it.effect('should handle disposal and re-initialization', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    it.effect('should handle uninitialized camera operations', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    const updateResult = yield* Effect.exit(service.update(0.016, { x: 0, y: 0, z: 0
        ...
        it.effect('should handle invalid mode switching', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    ...
    it.effect('should handle camera instance retrieval', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    it.effect('should handle aspect ratio updates', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    it.effect('should handle extreme yaw angle normalization', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
    ...
    it.effect('should handle minimal smoothing values', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({ ...DEFAULT_CAMERA_CONFIG, smoothing: 0.001
        ...
        it.effect('should handle concurrent operations', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize(DEFAULT_CAMERA_CONFIG)
