...
describe('ThirdPersonCamera', () => {
  ...
  it.effect('should initialize camera with default settings', () => Effect.gen(function* () {
    ...
    it.effect('should initialize with custom distance and height', () => Effect.gen(function* () {
    const service = yield* CameraService
    const config: CameraConfig = {
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
    ...
    it.effect('should validate camera configuration with property-based testing', () => Effect.gen(function* () {
    ...
    it.effect('should track target position changes', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    it.effect('should handle performance requirements for multiple updates', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
    ...
    it.effect('should handle horizontal rotation (yaw)', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
    ...
    it.effect('should handle vertical rotation (pitch) with limits', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
    ...
    it.effect('should apply sensitivity settings to rotation speed', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
    ...
    it.effect('should handle distance configuration changes', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
    ...
    it.effect('should handle FOV and smoothing configuration', () => Effect.gen(function* () {
    const service = yield* CameraService
    ...
    it.effect('should handle mode switching behavior', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
    ...
    it.effect('should preserve third-person mode when switching from first-person (lines 207-212)', () => Effect.gen(function* () {
    const service = yield* CameraService
    yield* service.initialize({
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
    ...
    it.effect('should handle disposal and resource cleanup', () => Effect.gen(function* () {
    const service = yield* CameraService
    const camera = yield* service.initialize({
    ...DEFAULT_CAMERA_CONFIG,
    mode: 'third-person',
