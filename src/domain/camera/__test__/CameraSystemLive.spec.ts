...
describe('CameraSystemLive', () => {
  describe('Layer構成', () => {
  it.effect('CameraSystemLiveがLayerとして正しく定義される', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('Layer統合が正しく動作する', () => Effect.gen(function* () {
    ...
    describe('サービス統合', () => {
  it.effect('複数のCameraServiceインスタンスを作成できる', () => Effect.gen(function* () {
  ...
  describe('型安全性', () => {
  it.effect('CameraServiceタグが正しく解決される', () => Effect.gen(function* () {
  ...
  describe('エラーハンドリング', () => {
  it.effect('Layerの依存関係解決エラーハンドリング', () => Effect.gen(function* () {
    // 正常なLayer提供での動作確認
  ...
  describe('リソース管理', () => {
  it.effect('Layerライフサイクル管理', () => Effect.gen(function* () {
  ...
  describe('パフォーマンス', () => {
  it.effect('Layer初期化のパフォーマンス', () => Effect.gen(function* () {
