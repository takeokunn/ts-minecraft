...
describe('CameraService', () => {
  ...
  it.effect('should validate camera config with validateCameraConfig', () => Effect.gen(function* () {
    // Valid config
    ...
    it.effect('should validate camera mode with validateCameraMode', () => Effect.gen(function* () {
    // Valid modes
    ...
    it.effect('should validate camera state with validateCameraState', () => Effect.gen(function* () {
    // Valid state
    const validState = {
    ...
    // Invalid state
    const invalidStateResult = yield* Effect.exit.effect(validateCameraState({ invalid: 'state'
  })
  ).toBe(true)
    return true
    }).pipe(Effect.provide(TestContext.TestContext))
    )
    describe('Schema Validations - Property-based Testing', () => Effect.gen(function* () {
    it.effect('should validate FOV range (30-120)', () => Effect.gen(function* () {
    // Valid FOV values
    ...
    it.effect('should validate sensitivity range (0.1-10)', () => Effect.gen(function* () {
    const validConfig: CameraConfig = {
    ...DEFAULT_CAMERA_CONFIG,
    sensitivity: 5,
    ...
    it.effect('should validate smoothing range (0-1)', () => Effect.gen(function* () {
    const validConfig: CameraConfig = {
    ...DEFAULT_CAMERA_CONFIG,
    smoothing: 0.5,
    const validatedConfig = yield* Schema.decodeUnknown(CameraConfigSchema)(validConfig)
    ...
    it.effect('should reject invalid configurations', () => Effect.gen(function* () {
    ...
    const sensitivityResult = yield* Effect.exit.effect(Schema.decodeUnknown(CameraConfigSchema)(invalidSensitivityConfig))
    if (Exit.isSuccess(sensitivityResult)) {
    return yield* Effect.fail(new Error('Should have failed for invalid sensitivity'))
    return true
    }).pipe(Effect.provide(TestContext.TestContext))
    )
    describe('Camera Mode Management', () => Effect.gen(function* () {
    it.effect('should set first-person mode', () => Effect.gen(function* () {
    ...
    it.effect('should set third-person mode', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should handle mode transitions', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should set camera target position', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should set camera position', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should handle multiple position updates efficiently', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    // Position validation through update method
    yield* cameraService.update(0.016, { x: position.x, y: position.y, z: position.z ) {$2}
    ...
    it.effect('should get view matrix', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should get projection matrix', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should get camera instance', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    const camera = yield* cameraService.getCamera()
    ...
    it.effect('should update aspect ratio', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should handle different aspect ratios', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    return true
    ) {$2}.pipe(Effect.provide(TestLayer))
    )
    describe('Mouse Look Control', () => {
    it.effect('should enable mouse look', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    // Mouse look functionality would be handled at a higher level
    return true
}).pipe(Effect.provide(TestLayer))
    )
    it.effect('should disable mouse look', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    // Mouse look functionality would be handled at a higher level
    return true
    }).pipe(Effect.provide(TestLayer))
    )
    it.effect('should handle mouse look toggle operations', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should reset camera to default state', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should handle reset operation performance', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    const start = Date.now()
    yield* Effect.gen(function* () {
    ...
    it.effect('should integrate with FirstPersonCamera Live implementation', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should integrate with ThirdPersonCamera Live implementation', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    ...
    it.effect('should create initializationFailed errors', () => Effect.gen(function* () {
    ...
    it.effect('should create notInitialized errors', () => Effect.gen(function* () {
    ...
    it.effect('should create invalidConfiguration errors', () => Effect.gen(function* () {
    ...
    it.effect('should create invalidMode errors', () => Effect.gen(function* () {
    ...
    it.effect('should create invalidParameter errors', () => Effect.gen(function* () {
    ...
    it.effect('should create resourceError errors', () => Effect.gen(function* () {
    ...
    it.effect('should create errors with optional parameters', () => Effect.gen(function* () {
    ...
    it.effect('should handle concurrent camera operations', () => Effect.gen(function* () {
    const cameraService = yield* CameraService
    // Test concurrent operations
    const concurrentOperations = [1, 2, 4, 8].map(() => Effect.gen(function* () {
    const start = Date.now()
