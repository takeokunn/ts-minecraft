...
describe('GameLoopServiceLive', () => {
  ...
  it.effect('should initialize with default configuration', () => Effect.gen(function* () {
    ...
    it.effect('should initialize with custom configuration', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    ...
    it.effect('should prevent double initialization when running', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should allow re-initialization after stop', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
    yield* gameLoop.stop()
  ...
  it.effect('should transition from idle to running', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
    const state = yield* gameLoop.getState()
    ...
    it.effect('should transition from running to paused', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
    ...
    it.effect('should transition from paused to running', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
    yield* gameLoop.pause()
    ...
    it.effect('should handle invalid pause transition', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should handle invalid resume transition', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should stop from any state', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
    yield* gameLoop.stop()
    ...
    it.effect('should handle multiple starts gracefully', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
    ...
    it.effect('should execute tick with callbacks', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should increment frame count on each tick', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should calculate delta time correctly', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should handle frame callbacks with errors', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should register multiple callbacks', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should unregister callbacks', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    const results: number[] = []
    ...
    it.effect('should clear callbacks on stop', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    const results: number[] = []
    yield* gameLoop.onFrame((
  ...
  it.effect('should accumulate performance metrics', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    ) {$2}.pipe(Effect.provide(GameLoopServiceLive))
    )
    it.effect('should fail when no metrics available', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should track dropped frames', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    ...
    it.effect('should maintain rolling buffer of FPS data', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should update configuration dynamically', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    ...
    it.effect('should merge partial configuration updates', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize({
    targetFps: 60,
    maxFrameSkip: 5,
    ...
    it.effect('should reset all state', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    ...
    it.effect('should reset configuration to defaults', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    ...
    it.effect('should reset frame counter', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.tick()
    yield* gameLoop.tick()
    ...
    it.effect('should schedule animation frames when running', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should cancel animation frame on pause', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
    ...
    it.effect('should handle rapid start/stop cycles', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
    yield* gameLoop.stop()
    ...
    it.effect('should detect frame skipping', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize({ targetFps: 60, maxFrameSkip: 2
})
    // Normal frame
    ...
    it.effect('should limit delta time to prevent huge jumps', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize({ targetFps: 60
  })
  )
  ...
  it.effect('should continue after callback errors in running state', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should handle concurrent callback registration', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    const results: number[] = []
    ...
    it.effect('should execute callbacks concurrently', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    const results: number[] = []
    // Add callbacks
  ...
  it.effect('should not leak memory with many callbacks', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    ...
    it.effect('should clean up on service disposal', () => Effect.gen(function* () {
    const gameLoop = yield* GameLoopService
    yield* gameLoop.initialize()
    yield* gameLoop.start()
