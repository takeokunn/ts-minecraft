...
/**
 * makeUnsafe helpers for Brand types
 */
import { unsafeCoerce } from 'effect/Function'

export const makeUnsafeDensityValue = (value: number): DensityValue => unsafeCoerce<number, DensityValue>(value)

export const makeUnsafeSpacingValue = (value: number): SpacingValue => unsafeCoerce<number, SpacingValue>(value)

export const makeUnsafeProbabilityValue = (value: number): ProbabilityValue =>
  unsafeCoerce<number, ProbabilityValue>(value)
