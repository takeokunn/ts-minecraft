...
export const makeUnsafeHumidity = (value: number): Humidity => unsafeCoerce<number, Humidity>(value)

export const makeUnsafePrecipitation = (value: number): Precipitation => unsafeCoerce<number, Precipitation>(value)

export const makeUnsafeElevation = (value: number): Elevation => unsafeCoerce<number, Elevation>(value)
