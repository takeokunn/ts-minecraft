...
const makeFurnitureService = (): FurnitureService => ({
  ...
  placeSign: () => Effect.fail({
    _tag: 'FurnitureError' as const,
    reason: 'block_occupied' as const,
    message: 'Not implemented yet'
  }),
  editSign: () => Effect.fail({
    _tag: 'FurnitureError' as const,
    reason: 'sign_not_found' as const,
    message: 'Not implemented yet'
  }),
  writeBook: () => Effect.fail({
    _tag: 'FurnitureError' as const,
  ...
  removeBed: () => Effect.fail({
    _tag: 'FurnitureError' as const,
    reason: 'bed_not_found' as const,
    message: 'Not implemented yet'
  }),
  removeSign: () => Effect.fail({
    _tag: 'FurnitureError' as const,
    reason: 'sign_not_found' as const,
    message: 'Not implemented yet'
  })
...
export const FurnitureServiceLive = Layer.succeed(
  FurnitureService,
  makeFurnitureService()
)