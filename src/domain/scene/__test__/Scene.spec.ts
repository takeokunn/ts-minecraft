...
describe('Scene', () => {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should reject invalid scene data', () => Effect.gen(function* () {
  ...
  it.effect('should validate valid scene transition with all fields', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should reject negative duration', () => Effect.gen(function* () {
  ...
  it.effect('should create scene transition error correctly', () => Effect.gen(function* () {
    ...
    it.effect('should validate scene transition error schema', () => Effect.gen(function* () {
    const errorData = {
  ...
  it.effect('should create scene initialization error correctly', () => Effect.gen(function* () {
    ...
    it.effect('should validate scene initialization error schema', () => Effect.gen(function* () {
    const errorData = {
  ...
  it.effect('should create scene cleanup error correctly', () => Effect.gen(function* () {
    ...
    it.effect('should validate scene cleanup error schema', () => Effect.gen(function* () {
    const errorData = {
