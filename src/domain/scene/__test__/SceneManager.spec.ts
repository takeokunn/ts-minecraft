...
describe('SceneManager', () => {
  ...
  it.effect('should initialize with no current scene', () => Effect.gen(function* () {
    ...
    it.effect('should get current state', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    const state = yield* manager.getState()
    ...
    it.effect('should transition to MainMenu scene', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    ...
    it.effect('should transition to Game scene', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    ...
    it.effect('should transition to Loading scene', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    ...
    it.effect('should fail to transition to unimplemented scene', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    ...
    it.effect('should handle scene transitions with custom transition data', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    yield* manager.transitionTo('MainMenu', {
    from: undefined,
    to: 'MainMenu',
    ...
    it.effect('should push and pop scenes correctly', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    // 最初のシーンに遷移
    yield* manager.transitionTo('MainMenu')
    ...
    it.effect('should fail to pop scene when stack is empty', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    ...
    it.effect('should handle concurrent transitions appropriately', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    // 並行遷移を実行
    ...
    it.effect('should update current scene', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    yield* manager.transitionTo('MainMenu')
    ...
    it.effect('should render current scene', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    yield* manager.transitionTo('Game')
    ...
    it.effect('should cleanup properly', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    // シーンを設定
    yield* manager.transitionTo('MainMenu')
    yield* manager.pushScene('Game')
    ...
    it.effect('should handle update and render when no scene is active', () => Effect.gen(function* () {
    const manager = yield* SceneManager
    ...
    it.effect('should create scenes correctly', () => Effect.gen(function* () {
    const manager = yield* SceneManager
