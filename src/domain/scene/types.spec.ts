...
describe('domain/scene/types', () => {
  ...
  it('Loading progress is branded within [0,1]', () => {
    fc.assert(
      fc.property(fc.float({ min: 0, max: 1, noDefaultInfinity: true, noNaN: true }), (value) => {
  ...
  it('TransitionEffect.Fade stores branded durations', () => {
    fc.assert(
      fc.property(fc.float({ min: 0, max: 10, noDefaultInfinity: true, noNaN: true }), (durationValue) => {
