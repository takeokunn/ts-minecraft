...
export const ArchetypeBuilder = S.Union(PlayerArchetypeBuilder, BlockArchetypeBuilder, CameraArchetypeBuilder, TargetBlockArchetypeBuilder, ChunkArchetypeBuilder)
