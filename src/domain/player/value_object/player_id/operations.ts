 ...
 * 新しいPlayerIdを生成
 */
export const generate = (): Effect.Effect<PlayerId, never> => Effect.sync(() => `player_${uuidv4()}` as PlayerId)
 ...
 */
export const makeUnsafe = (value: string): PlayerId => value as PlayerId
