...
describe('PlayerService', () => {
  ...
  describe('Error Handling', () => {
    ...
    it.effect('should create validation errors', () =>
      Effect.gen(function* () {
    ...
    it.effect('should create component errors', () =>
      Effect.gen(function* () {
        const playerId = BrandedTypes.createPlayerId('test-player')
  ...
  describe('Schema Validation', () => {
    it.effect('should validate correct player config', () =>
      Effect.gen(function* () {
        const config = {
    ...
    it.effect('should validate position with correct bounds', () =>
      Effect.gen(function* () {
    ...
    it.effect('should validate rotation with correct bounds', () =>
      Effect.gen(function* () {
    ...
    it.effect('should reject invalid rotation bounds', () =>
      Effect.gen(function* () {
        const config = {
          playerId: 'test-player',
  ...
  describe('Type Safety', () => {
    ...
    it.effect('should validate component types structure', () =>
      Effect.gen(function* () {
    ...
    it.effect('should validate position component structure', () =>
      Effect.gen(function* () {
    ...
    it.effect('should validate rotation component structure', () =>
      Effect.gen(function* () {
