...
describe('PlayerService', () => {
  ...
  it.effect('should have all required methods', () => Effect.gen(function* () {
    ...
    it.effect('should create validation errors', () => Effect.gen(function* () {
    const error = createPlayerError.validationError('Invalid config')
    expect(error._tag).toBe('PlayerError')
    expect(error.reason).toBe('VALIDATION_ERROR')
    expect(error.message).toContain('Invalid config')
    )
    it.effect('should create component errors', () => Effect.gen(function* () {
    const playerId = BrandedTypes.createPlayerId('test-player')
  ...
  it.effect('should enforce branded types for PlayerId', () => Effect.gen(function* () {
    ...
    it.effect('should validate component types structure', () => Effect.gen(function* () {
  ...
  Effect.gen(function* () {
    ...
    it.effect('should validate rotation component structure', () => Effect.gen(function* () {
