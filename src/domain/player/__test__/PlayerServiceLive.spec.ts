...
describe('PlayerService Integration Tests', () => {
  ...
  describe('Player Creation and Destruction', () => {
    effectIt.effect('should create a player with complete configuration', () =>
      Effect.gen(function* () {
    ...
    effectIt.effect('should create a player with minimal configuration using defaults', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should destroy a player and clean up resources', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should prevent duplicate player creation', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
  ...
  describe('Player State Management', () => {
    effectIt.effect('should update player position', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should update player rotation', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should update player health', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should update player active state', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should update multiple player properties at once', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
  ...
  describe('Error Handling and Validation', () => {
    effectIt.effect('should handle non-existent player operations', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should validate input data and reject invalid values', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
  ...
  describe('Multi-Player Operations', () => {
    effectIt.effect('should manage multiple players simultaneously', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should get players in range', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should get player statistics', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
  ...
  describe('Performance and Concurrency Tests', () => {
    effectIt.effect('should handle high-frequency player operations efficiently', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should handle concurrent player creation and deletion', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
  ...
  describe('ECS Integration Tests', () => {
    effectIt.effect('should properly integrate with EntityManager', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
        const entityManager = yield* EntityManager
    ...
    effectIt.effect('should handle ECS errors gracefully', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
        const entityManager = yield* EntityManager
  ...
  describe('Memory Management and Resource Cleanup', () => {
    effectIt.effect('should not leak memory after player deletion', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
  ...
  describe('Edge Cases and Boundary Conditions', () => {
    effectIt.effect('should handle rapid state changes correctly', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should handle extreme coordinate values', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
    ...
    effectIt.effect('should maintain consistency under error conditions', () =>
      Effect.gen(function* () {
        const playerService = yield* PlayerService
