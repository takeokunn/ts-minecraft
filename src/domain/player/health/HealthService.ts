...
export interface HealthService {
   ...
   */
  readonly getHealthState: (
    playerId: PlayerId
  ) => Effect.Effect<HealthState, HealthError>
   ...
   */
  readonly applyNaturalRegeneration: (
    playerId: PlayerId
  ) => Effect.Effect<CurrentHealth, HealthError>
