 ...
 */
export const makeUnsafeTemperatureCelsius = (value: number): TemperatureCelsius =>
  unsafeCoerce<number, TemperatureCelsius>(value)

export const makeUnsafeTemperatureDelta = (value: number): TemperatureDelta =>
  unsafeCoerce<number, TemperatureDelta>(value)
