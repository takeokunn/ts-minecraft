 ...
 */
export const makeUnsafeRelativeHumidity = (value: number): RelativeHumidity =>
  unsafeCoerce<number, RelativeHumidity>(value)

export const makeUnsafeAbsoluteHumidity = (value: number): AbsoluteHumidity =>
  unsafeCoerce<number, AbsoluteHumidity>(value)
