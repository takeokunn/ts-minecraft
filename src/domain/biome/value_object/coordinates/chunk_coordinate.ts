 ...
 */
export const makeUnsafeChunkX = (value: number): ChunkX => value as ChunkX

export const makeUnsafeChunkZ = (value: number): ChunkZ => value as ChunkZ

export const makeUnsafeChunkCoordinate = (x: number, z: number): ChunkCoordinate =>
  ({
    x: makeUnsafeChunkX(x),
    z: makeUnsafeChunkZ(z),
  }) as ChunkCoordinate

export const makeUnsafeLocalX = (value: number): LocalX => value as LocalX

export const makeUnsafeLocalZ = (value: number): LocalZ => value as LocalZ

export const makeUnsafeLocalCoordinate = (x: number, z: number): LocalCoordinate =>
  ({
    x: makeUnsafeLocalX(x),
    z: makeUnsafeLocalZ(z),
  }) as LocalCoordinate
