...
import { reviveEpochZero } from './domain/value'
import { ConfigLayer, MainLayer, TestLayer, makeAppService, makeConfigService } from './infrastructure'

const providerLayer = (entries: Record<string, string>) =>
  Layer.succeed(ConfigProvider.ConfigProvider, ConfigProvider.fromMap(new Map(Object.entries(entries))))
