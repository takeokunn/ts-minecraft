...
describe('Port/Adapter Integration Tests', () => {
  describe('Math Port Implementation', () => {
    it('should provide complete Vector3 operations', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(vector3Test, TestLayer))
    ...
    it('should provide complete Quaternion operations', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(quaternionTest, TestLayer))
    ...
    it('should provide complete Ray operations', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(rayTest, TestLayer))
    ...
    it('should support multiple math implementations', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(adaptabilityTest, TestLayer))
  ...
  describe('Render Port Implementation', () => {
    it('should provide complete mesh management operations', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(renderTest, TestLayer))
  ...
  describe('World Repository Port Implementation', () => {
    ...
    it('should handle chunk operations', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(chunkTest, TestLayer))
  ...
  describe('Terrain Generator Port Implementation', () => {
    it('should generate terrain chunks', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(terrainTest, TestLayer))
    ...
    it('should support different terrain types', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(terrainTypesTest, TestLayer))
  ...
  describe('Spatial Grid Port Implementation', () => {
    it('should manage spatial entities', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(spatialTest, TestLayer))
    ...
    it('should handle spatial queries efficiently', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(queryTest, TestLayer))
  ...
  describe('Port Adapter Switching', () => {
    it('should support hot-swapping implementations', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(swapTest, TestLayer))
    ...
    it('should maintain interface consistency across implementations', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(consistencyTest, TestLayer))
    ...
    it('should support configuration-based adapter selection', async () => {
      ...
      const result = await Effect.runPromise(Effect.provide(configTest, TestLayer))
  ...
  describe('Error Handling in Ports', () => {
    ...
    it('should propagate adapter errors correctly', async () => {
      const adapterErrorTest = Effect.gen(function* () {
        ...
        const createResult = yield* Effect.either(renderPort.createMesh('invalid-mesh', invalidMeshData))
      ...
      const result = await Effect.runPromise(Effect.provide(adapterErrorTest, TestLayer))
