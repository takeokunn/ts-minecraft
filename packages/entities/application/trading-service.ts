...
import type { Villager, VillagerId } from '../domain/village-model'
import { TradeOfferId, TradeSuccess, TradeFailure, type TradeFailureReason, type TradeOffer, type TradeResult } from '../domain/trading-model'
