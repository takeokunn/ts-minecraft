// Application-layer interface for keyboard and mouse input.
// Defined here so application-layer services and tests can reference input capability
// without importing from the presentation layer.
