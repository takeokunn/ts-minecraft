...
/**
 * Number index to BlockType mapping for storage — single source of truth.
 * Array position = storage index (0 = AIR, 1 = DIRT, …).
 */
...
/**
 * BlockType to number index mapping for storage — derived from INDEX_TO_BLOCK_TYPE.
 * This is the reverse lookup: BlockType → storage index.
 */
