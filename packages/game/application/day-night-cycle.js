...
export const updateDayNightCycle = (deltaTime, lights, timeService) => Effect.gen(function* () {
    const timeOfDay = yield* timeService.advanceTick(deltaTime).pipe(Effect.andThen(timeService.getTimeOfDay()));
    ...
    yield* Effect.sync(() => {
        ...
        lights.light.color.setHSL(0.06 - horizonBlend * 0.04, // hue: ~0.06 (orange) near horizon → ~0.02 at night
...
//# sourceMappingURL=../../../dist/packages/game/application/day-night-cycle.js.map