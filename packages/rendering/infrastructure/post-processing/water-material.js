...
`;
export const createWaterMaterial = (refractionTexture, width, height) => {
    const uniforms = {
        uTime: { value: 0.0 },
...
//# sourceMappingURL=../../../../dist/packages/rendering/infrastructure/post-processing/water-material.js.map