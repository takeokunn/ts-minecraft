...
export const computeLimbAngle = (speed, t, side, limb) => {
    if (speed < SPEED_THRESHOLD)
        return 0;
    const phase = phaseOf(side, limb);
    return Math.sin((2 * Math.PI * speed * t) / STRIDE_LENGTH + phase) * LIMB_SWING_AMPLITUDE;
};
//# sourceMappingURL=../../../../dist/packages/rendering/infrastructure/entity/walk-cycle.js.map