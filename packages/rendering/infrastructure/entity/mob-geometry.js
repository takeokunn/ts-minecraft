...
const geometryCache = MutableHashMap.empty();
const getOrCreateGeometry = (key, size, pivotTop) => Option.match(MutableHashMap.get(geometryCache, key), {
...
const materialCache = MutableHashMap.empty();
const getOrCreateMaterial = (key, color) => Option.match(MutableHashMap.get(materialCache, key), {
    onSome: (cached) => cached,
    onNone: () => {
...
const ZOMBIE_PALETTE = { head: 0x5a8a3a, body: 0x3f5e7a, arm: 0x5a8a3a, leg: 0x5a8a3a };
const COW_PARTS = {
    head: [0.5, 0.5, 0.4],
    body: [0.625, 0.5, 1.0],
    leg: [0.25, 0.75, 0.25],
};
const COW_PALETTE = { head: 0x4a3020, body: 0x4a3020, leg: 0xf0f0f0 };
const PIG_PARTS = {
    head: [0.5, 0.5, 0.5],
    body: [0.5, 0.5, 0.625],
    leg: [0.25, 0.375, 0.25],
};
const PIG_PALETTE = { head: 0xf0a0a0, body: 0xf0a0a0, leg: 0xf0a0a0 };
const SHEEP_PARTS = {
    head: [0.375, 0.375, 0.5],
    body: [0.5, 0.5, 0.875],
    leg: [0.25, 0.75, 0.25],
};
const SHEEP_PALETTE = { head: 0xf0d8b0, body: 0xf5f5f5, leg: 0xf0d8b0 };
const buildBiped = (typeKey, parts, palette) => {
...
const buildQuadruped = (typeKey, parts, palette) => {
...
export const buildMobGroup = (type) => {
    switch (type) {
        case 'Zombie':
...
//# sourceMappingURL=../../../../dist/packages/rendering/infrastructure/entity/mob-geometry.js.map