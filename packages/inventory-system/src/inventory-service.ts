...
import { ItemStack, createStack, mergeStacks, canMerge, MAX_STACK_SIZE, addToStack, removeFromStack } from '@ts-minecraft/domain'
import { SlotIndex } from '@ts-minecraft/kernel'
import { InventorySaveDataSchema, type InventorySaveData } from '@ts-minecraft/domain'
