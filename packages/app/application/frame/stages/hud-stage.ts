...
import type { FrameHandlerDeps, FrameSettingsView, FrameStageRefs } from '@ts-minecraft/app/frame/types'
import type { FrameHudServices, FrameSettingsServices } from '@ts-minecraft/app/frame/frame-service-types'
