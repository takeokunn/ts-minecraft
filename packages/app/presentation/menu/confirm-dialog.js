...
export class ConfirmDialogService extends Effect.Service()('@minecraft/presentation/ConfirmDialog', {
    effect: Effect.flatMap(DomOperationsService, (dom) => Effect.succeed({
        // Short-circuits to false in SSR / non-DOM environments.
        show: (message, confirmLabel, cancelLabel = 'Cancel') => Effect.gen(function* () {
            ...
            })).pipe(Effect.andThen(Deferred.await(result)), Effect.scoped);
        }),
    })),
}) {
}
export const ConfirmDialogLive = ConfirmDialogService.Default;
//# sourceMappingURL=../../../../dist/packages/app/presentation/menu/confirm-dialog.js.map