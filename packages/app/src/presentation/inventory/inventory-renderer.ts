...
import { InventoryService, INVENTORY_SIZE, HOTBAR_START, type InventorySlot } from '@ts-minecraft/inventory-system'
...
import type { Recipe } from '@ts-minecraft/domain'
import { SlotIndex } from '@ts-minecraft/kernel'
import { CHUNK_HEIGHT, CHUNK_SIZE, blockTypeToIndex } from '@ts-minecraft/domain'
