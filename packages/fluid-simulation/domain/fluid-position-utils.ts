...
import { CHUNK_HEIGHT, CHUNK_SIZE, blockIndex, type Chunk, type ChunkCoord } from '@ts-minecraft/domain'
import type { FluidType } from '@ts-minecraft/domain'
...
export const positionFromChunk = (chunk: Chunk, idx: number): Position => {
