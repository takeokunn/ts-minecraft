...
export declare const PhysicsWorldPort: Context.Tag<PhysicsWorldPort, PhysicsWorldPort>;
...
export declare const RigidBodyPort: Context.Tag<RigidBodyPort, RigidBodyPort>;
...
export declare const ShapePort: Context.Tag<ShapePort, ShapePort>;
//# sourceMappingURL=physics-port.d.ts.map