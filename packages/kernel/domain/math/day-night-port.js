...
export { Option };
const hasFunctionProperty = (value, key) => key in value && typeof Reflect.get(value, key) === 'function';
...
const DayNightLightsPortSchemaBase = Schema.mutable(Schema.Struct({
    ...
    sky: Schema.declare((u) => {
        if (!Option.isOption(u))
            return false;
...
//# sourceMappingURL=../../../../dist/packages/kernel/domain/math/day-night-port.js.map