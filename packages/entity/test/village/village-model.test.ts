...
describe('village/village-model', () => {
  describe('villagerLevelFromExperience', () => {
    ...
    it('returns maximum level 4 for any experience above the highest threshold', () => {
      expect(villagerLevelFromExperience(1000)).toBe(4)
      expect(villagerLevelFromExperience(Number.MAX_SAFE_INTEGER)).toBe(4)
    })
  })
