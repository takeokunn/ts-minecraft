...
import { DEFAULT_JUMP_VELOCITY, DEFAULT_SPRINT_SPEED, DEFAULT_WALK_SPEED, MovementService, SPRINT_JUMP_HORIZONTAL_MULTIPLIER } from '@ts-minecraft/entity/application/movement-service';
