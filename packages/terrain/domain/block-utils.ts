...
const PICKAXE_HARVEST_SETS: Partial<Record<BlockType, HashSet.HashSet<BlockType>>> = {
...
export const canHarvestBlock = (blockType: BlockType, selectedTool: Option.Option<BlockType>): boolean =>
