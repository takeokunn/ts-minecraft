...
export const JAGGED_AMP = [
    [-1.0, 15],
    [-0.3, 5],
    [0.0, 0], // suppressed from here on
    [1.0, 0],
];
//# sourceMappingURL=../../../dist/packages/terrain/domain/terrain-splines.js.map