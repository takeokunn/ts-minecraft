...
import { LAKE_THRESHOLD, LAKE_MAX_DEPTH, LAKE_MIN_DEPTH, RIVER_MIN_CUT, RIVER_MAX_CUT, RIVER_WATER_LEVEL, } from './constants';
...
export const computeLakeBasin = (biome, lakeNoiseVal, initialSurfaceY) => {
...
export const resolveSurfaceY = (biome, initialSurfaceY, lakeBasinY) => {
...
export const determineWaterLevel = (biome, surfaceY, lakeBasinY) => {
    if (biome === 'RIVER')
        return Option.some(RIVER_WATER_LEVEL);
    if (surfaceY < SEA_LEVEL)
        return Option.some(SEA_LEVEL);
    /* c8 ignore next */
    return Option.map(lakeBasinY, () => LAKE_LEVEL);
};
export const fillWaterForColumn = (blocks, lx, lz, biome, surfaceY, lakeBasinY, waterBlockIndex) => {
...
//# sourceMappingURL=../../../../dist/packages/terrain/domain/terrain/lake-generator.js.map